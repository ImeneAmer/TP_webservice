 ...
 * 
 */
@WebServiceClient(name = "BanqueWebService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8090/BanqueService?wsdl")
public class BanqueWebService
    extends Service
{

    private final static URL BANQUEWEBSERVICE_WSDL_LOCATION;
    private final static WebServiceException BANQUEWEBSERVICE_EXCEPTION;
    private final static QName BANQUEWEBSERVICE_QNAME = new QName("http://ws/", "BanqueWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8090/BanqueService?wsdl");
